...
# from typing import Optional # Optional is a type hint that indicates that a variable can be None
...
#     default_reward=0.9, default_iters=50, default_timesteps=10000
# )
# parser.add_argument(
#     "--corridor-length",
#     type=int,
#     default=20,
#     help="Length of the corridor",
# )
...
#     The reward function is -0.01 per steps taken and a uniform random value between 0.5 and 1.5 when reaching the goal
#     """
#     def __init__(self, config:Optional[dict]=None):
#         config = config or {}
#         self.end_pos = config.get("corridor_length", 18)
#         self.cur_pos = 0
